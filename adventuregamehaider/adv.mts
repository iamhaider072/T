...
//Game Variables
var enemies:string[]=['Skeleton','Zombie','Warrior','Assasin'];
var maxEnemyHealth:number=75;
var maxEnemyDamage:number=25;

//Player Variables
var Health:number=100;
var AttackDamage:number=50;
var numHealthPotions:number=3;
var HealthPotionHealamount:number=50;
var HealthPotionDropCHance:number=30;
...
console.log(chalk.bgGray(`You run away from the ${enemy}.`))
continue GAME;
}
if(Health<1){
